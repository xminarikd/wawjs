...
describe("cvicenie04 - Object properties concepts", function() {
  ...
  describe("Object.keys", function() {
    it("allOwnKeys() works for Strings and Symbols", function() {
      ...
      assert(Object.keys(o), ["a"], "Object.keys() does not return Symbols");
  ...
  describe("Object.values", function() {
    it("allOwnValues() works for Strings and Symbols", function() {
      ...
      assert(Object.values(o), [10], "Object.values does not return Symbols");
  ...
  describe("for..in", function() {
    it("forIn supports Symbols", function() {
      ...
      assert.deepStrictEqual(props, ["a"], "for..in does not see Symbols");

      var props2 = [];
      forIn(x, p => props2.push(p));
      assert(props2.includes("a"));
      assert(props2.includes(s), "forIn does see Symbols");
    });
    ...
    it("forIn supports nonenumerable", function() {
      ...
      assert.deepStrictEqual(props2, ["a", "b"], "but visible using forIn");
    });
  });
